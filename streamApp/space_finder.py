...
#get_frame("data\\car1.webm")
try :
    with open("data\\parking_space.conf",'rb') as f:
    ...
    if event==cv.EVENT_RBUTTONDOWN :
        ...
        for (x_l,y_l) in POS_LIST :
            ...
            if x_l<x<x_l+W and y_l<y<y_l+H:
                POS_LIST.pop(i)
            i=i+1
    with open("data\\parking_space.conf","wb") as f:
